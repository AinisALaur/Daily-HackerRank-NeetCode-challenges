...
- [Find First Occurrence](#challenge-4)
- [Maximum Number of Non-Overlapping Intervals](#challenge-5)
- [Validate Properly Nested Brackets](#challenge-6)
- [Min-Tracking Stack Implementation](#challenge-7)
- [One-Pass Removal of k-th Node from End](#challenge-8)
- [Count Number Pairs](#challenge-9)
- [Remove Consecutive Duplicates from Sorted Linked List](#challenge-10)
- [Generate Valid Angle Bracket Sequences](#challenge-11)
- [Remove Elements Within K Distance](#challenge-12)
- [Two Sum](#challenge-13)
